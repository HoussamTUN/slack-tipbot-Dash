...
const tipbotTxt = {
  ...
  'helpText': [
    ...
    '\t\t_@mr.robot what is my balance_',

    //'help_send':
    '*send*\t\t\t\ttell the bot to send coins to someone; \n' +
    '\t\t_@mr.robot send 0.1 NXS to @someone_ \n' +
    '\t\t_aliases: give, tip_ \n' +
    '\t\t\t\tWorks also with major fiat currencies (use *currencies* command to see the list); \n' +
    '\t\t_@mr.robot give 4 USD to @someone_',

    // 'help_deposit':
    '*deposit*\t\task the bot for a deposit address; _@mr.robot let me deposit!_',
    ...
    '\t\t_@mr.robot withdraw 1 NXS to 2XXxxXXxxXXxxXXxxXXxxXXxxXXxxXXxxXXxxXXxxXXxxXX_',

    // 'help_currencies':
    '*currencies*\task the bot for a list of supported currencies.\n' +
    '\t\t_@mr.robot what currencies do you know?_ ',

    // 'help_price':
    '*price*\t\t\task the bot for the Nexus price in a particular currency. Price info from coinmarketcap.\n ' +
    '\t\t_@mr.robot price in USD!_ ',
    ...
    // 'help_convert':
    '*convert*\t\task the bot to convert between a particular currency and Nexus (or visa versa).\n' +
    '\t\t_@mr.robot 0.03 Nexus to GBP_ \t or \t _@mr.robot 15 EURO to Nexus_\n',
  ],

  'help_rain':
  '*rain*\t\t\tcheck the available raindrops. \n' +
  '\t\t\tEach user that has tipped another user will receive a _raindrop_ (read: free Nexus) from the rain fund when the donation threshold is reached.',
  ...
  '\t\t_@mr.robot autowithdraw 0.5 NXS 2XXxxXXxxXXxxXXxxXXxxXXxxXXxxXXxxXXxxXXxxXXxxXX',
  ...
  '\t\t_@mr.robot balance check @naruby_ \n' +
  '\n\n' +
  '*whisper*\tSend a message in a private channel to a user as Nexusbot.\n' +
  '\t\t\t\t\tUse case :moderator warning.\n' +
  '\t\t_@mr.robot whisper @narbuy stop being silly man._\n' +
  '\n\n' +
  '\n',
  ...
  'HelpRandom1': 'Here is an example of one of my commands, type "@mr.robot help" for my full list. ',
  // 'HelpRandom2': 'You can get information about all my other cool tricks via the *help* command. \n Have a nice day !',

  // NEW USER
  'WarningNewUser1': 'Welcome to the Nexus Community! Feel free to join #trading if you like to discuss trading cryptocurrency, #mining for help mining, #philosophy for the deep thinkers, #twitter for Nexus tweets, and #support if you need help. You can also ask anything here as well, ',
  'WarningNewUser2': '.',
  ...
  'SupportedBase': 'And does it need saying: *NXS* is supported !',

  // RAIN
  'RainThreshold1': 'Rain threshold is: ',
  'RainThreshold2': 'Raindrops (aka free nexus) will fall when rain balance is more then the set threshold.',
  'RainThresholdNotSet': 'Dear Nexus nexus, the Rain threshold isn\'t set yet. \n' +
  ' You can do that with the *rain threshold _amount_* command.',
  // 'RainTimer': 'Rainshine will be checked every *',
  // 'RainTimerUnit': ' minute(s)*',
  // 'RainTimerNotSet': 'Dear Nexus God, the rain timer is not set yet.\n' +
  ...
  'RainReqDonation3': '_ will be redistributed as _raindrops_ (aka free Nexus).',
  'RainEmpty': ':sun_behind_cloud:no raindrops available to cast. :disappointed:',
  'RainRecieved': 'As reward of tipping your fellow Nexus user(s) you received a raindrop of ',
...
const userTxt = {
  ...
  'BalanceWarningHigh': 'This tip jar is filling up. Please consider withdrawing some Nexus.',
  ...
  'SendPrivateMssSendingUser': ' you\'re a great Nexus Chat user :thumbsup: \nLets see how much there is left in your tip jar now: \n',
